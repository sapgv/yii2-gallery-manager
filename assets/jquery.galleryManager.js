(function ($) {
    ...
    function galleryManager(el, options) {
        ...
        var photoTemplate = '<div class="photo">' + '<div class="image-preview" style="text-align: center"><img src=""/></div><div class="caption">';
        if (opts.hasName) {
            photoTemplate += '<h5></h5>';
        }
        if (opts.hasDesc) {
        ...
        photoTemplate += '<span class="mainPhoto btn btn-default btn-xs"><i class="glyphicon star"></i></span> ';
        ...
        function addPhoto(id, src, name, description, rank, main) {
            ...
            if (main) {
                $('.star', photo).css({"color":"gold"});
                $('.star', photo).addClass('glyphicon-star');
            }
            else {
                $('.star', photo).addClass('glyphicon-star');
            }
        ...
        $images
            .on('click', '.photo .mainPhoto', mainClick)
        ...
        for (var i = 0, l = opts.photos.length; i < l; i++) {
            ...
            addPhoto(resp['id'], resp['preview'], resp['name'], resp['description'], resp['rank'], resp['main']);
        }
    }
